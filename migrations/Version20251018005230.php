 ...
 */
final class Version20251018005230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jewelries ADD gemtype_id INT DEFAULT NULL, DROP gemtype');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jewelries ADD gemtype VARCHAR(255) NOT NULL, DROP gemtype_id');
    }
}
